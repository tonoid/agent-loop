...
* let a job take one worker through a pacing pause ([#18](https://github.com/tonoid/agent-loop/issues/18)) ([957331a](https://github.com/tonoid/agent-loop/commit/957331aa9306fa0eddaf8fbb5046da758fcfdb95))
...
* close a finished agent that is holding its account's slot ([#16](https://github.com/tonoid/agent-loop/issues/16)) ([0278ee1](https://github.com/tonoid/agent-loop/commit/0278ee1a57470412743590b31de5a6749b5adafa))
* pace an account against its window line, not against the reset ([#17](https://github.com/tonoid/agent-loop/issues/17)) ([3aff04c](https://github.com/tonoid/agent-loop/commit/3aff04c6584a4dbdea162a05c43f7bcbbabc9728))
...
* stop warning on herdr 0.9.0, and start the live worker like a spawn does ([#19](https://github.com/tonoid/agent-loop/issues/19)) ([5b242e6](https://github.com/tonoid/agent-loop/commit/5b242e641bb704678d34c346f5a4a53ad17fdbb1))
